 ...
 *    gợi ý: lấy mảng trùng rồi khử các phần tử bị trùng
...
// function categoriesType(datas) {
//   let categoriesType = [datas[0].category];
//   for (i = 1; i < dataLength; i++) {
//     for (j = 0; j < categoriesType.length; j++) {
//       console.log("categoriesType", categoriesType[j]);
//       console.log("data.category", datas[i].category);
//       if (categoriesType[j] != datas[i].category) {
//         categoriesType.push(datas[i].category);
//       }
//     }
//   }
...
// console.log("ket qua bai 5: ", categoriesType(products));

// function categoriesCountOfType() {}
